...
class UsersController extends Controller
{
	...
	public function index() 
	{
		...
		$users = $this->UsersModel->getAllUsers( $pagination);
	...
	public function user( $user_id = 0 ) 
	{
		...
		$user = $this->UsersModel->getUserById( ( int )$user_id );
	...
	public function sign_in() 
	{
		...
		if ( User::checkCookie('user_name') && User::checkCookie('user_password') ) {
			$cookie = [	'user_name' => $_COOKIE['user_name'],
