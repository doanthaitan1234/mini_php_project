...
class UsersModel extends Model
{
	 ...
	 * Read Users
	 */
	public function getAllUsers( array $pagination ) 
	{
		$sql = Sql::query()
	...
	public function signIn( array $user ) 
	{
		...
		if ( ! empty( $user ) ) {
			if ( password_verify( $user_password, $user['user_password'] ) ) {
				...
				if ($_POST['remember']) {
					User::setCookie('user_name', $_POST['user-name']);
					User::setCookie('user_password', $_POST['user-password']);
				} else {
					User::removeCookie('user_name');
					User::removeCookie('user_password');
				}
	 ...
	 *  Change User Role
	 */
	public function changeUserRole( array $user ) 
	{
